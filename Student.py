...
class Student(Base):
    ...
    majors: Mapped[List["StudentMajor"]] = relationship(back_populates="students",
                                                        cascade="all, save-update, delete-orphan")
    sections: Mapped[List["Enrollment"]] = relationship(back_populates="students",
                                                        cascade="all, save-update, delete-orphan")
